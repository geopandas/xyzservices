...
- Added ``TileProvider.from_qms()`` allowing to create a ``TileProvider`` object from remote Quick Map Services repository (#71)
...
- Indent providers JSON file for the better readability (#64)
